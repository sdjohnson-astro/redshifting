...
def createSpec1Dfiles(mask):
   ...
   import cPickle
   gdict=cPickle.load(open('{}.p'.format(mask),'rb'))
...
redshiftgui = ldss3_redshiftgui(args.m, args.xsize, args.ysize)